...
std::vector<std::string> IMAGENET_NAMES{
"tench, Tinca tinca",
...
void softmax(Tensor* score, int* cls, float* prob)
{
...
int main(int argc, const char* argv[]) {
    ...
    float normals[3] = {0.017, 0.017,0.017};
    ...
    int cls;
    float prob;
    softmax(outputTensor, &cls, &prob);
    printf("cls: %s  prob: %f\n", IMAGENET_NAMES[cls].c_str(), prob);
